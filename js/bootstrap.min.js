  ...
  +(function(t) {
    ...
    function e(e) {
      return this.each(function() {
        ...
        (n || !/destroy|hide/.test(e)) &&
          (n || i.data("bs.tooltip", (n = new o(this, r))), "string" == typeof e && n[e]());
      });
    }
    var o = function(t, e) {
      (this.type = null),
    ...
    (o.VERSION = "3.3.4"),
      ...
      (o.prototype.enter = function(e) {
        ...
        return o && o.$tip && o.$tip.is(":visible")
          ? void (o.hoverState = "in")
          : (o ||
              ((o = new this.constructor(e.currentTarget, this.getDelegateOptions())),
      ...
      (o.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (l) {
            ...
            (a =
              "bottom" == a && h.bottom + c > v.bottom
                ? "top"
                : "top" == a && h.top - c < v.top
                  ? "bottom"
                  : "right" == a && h.right + f > v.width ? "left" : "left" == a && h.left - f < v.left ? "right" : a),
          ...
          t.support.transition && this.$tip.hasClass("fade")
            ? r.one("bsTransitionEnd", y).emulateTransitionEnd(o.TRANSITION_DURATION)
            : y();
        }
      }),
    ...
    function e(e) {
      return this.each(function() {
        var i = t(this),
          ...
          r = "object" == typeof e && e;
        (n || !/destroy|hide/.test(e)) &&
          (n || i.data("bs.popover", (n = new o(this, r))), "string" == typeof e && n[e]());
      });
    }
    var o = function(t, e) {
      ...
      (o.prototype.setContent = function() {
        ...
        t.find(".popover-title")[this.options.html ? "html" : "text"](e),
          t
            ...
            .detach()
            .end()
            [this.options.html ? ("string" == typeof o ? "html" : "append") : "text"](o),
    ...
    (o.VERSION = "3.3.4"),
      ...
      (o.prototype.show = function() {
        var e = this.element,
          ...
          i = e.data("target");
        if (
          (i || ((i = e.attr("href")), (i = i && i.replace(/.*(?=#[^\s]*$)/, ""))), !e.parent("li").hasClass("active"))
        ) {
      ...
      (o.prototype.activate = function(e, i, n) {
        ...
        s.length && a ? s.one("bsTransitionEnd", r).emulateTransitionEnd(o.TRANSITION_DURATION) : r(),
          s.removeClass("in");
      });
    var i = t.fn.tab;
    (t.fn.tab = e),
