  ...
  (function() {
    ...
    this.ScrollReveal = (function() {
      ...
      ScrollReveal.prototype.isSupported = function() {
        ...
        return (
          ("WebkitTransition" in style && "WebkitTransform" in style) || ("transition" in style && "transform" in style)
        );
      };
      ...
      function _isElemVisible(elem) {
        ...
        function confirmBounds() {
          var // Define the element’s functional boundaries using its view factor.
